...
@Component({
  selector: 'TrainingCenter-home',
  templateUrl: './TrainingCenter-home.component.html',
  styleUrls: ['./TrainingCenter-home.component.scss']
})
export class TrainingCenterHomeComponent implements AfterViewInit {
