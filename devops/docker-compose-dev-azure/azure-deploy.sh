...
resourcename="trainingcenterproject"  # lower case, only
resourcegroup="trainingcenterproject_rg"
...
# git clone https://github.com/apilogicserver/trainingcenterproject.git
# cd trainingcenterproject
...
az group create --name trainingcenterproject_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group trainingcenterproject_rg --sku S1 --is-linux
az container create --resource-group trainingcenterproject_rg --name trainingcenterproject --image apilogicserver/trainingcenterproject:latest --dns-name-label trainingcenterproject --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//trainingcenterproject.westus.azurecontainer.io:5656'
