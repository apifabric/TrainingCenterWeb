...
@Component({
  selector: 'CourseMaterial-home',
  templateUrl: './CourseMaterial-home.component.html',
  styleUrls: ['./CourseMaterial-home.component.scss']
})
export class CourseMaterialHomeComponent implements AfterViewInit {
